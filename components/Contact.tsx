        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-16">
            <a
              ...
              aria-label="Connect with Habeeba Faiza on LinkedIn"
            ...
            >
              <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
            ...
            <a
              ...
              aria-label="Send email to Habeeba Faiza"
          ...
          <div className="grid md:grid-cols-3 gap-8 pt-12 border-t border-neutral-700">
            <div>
              ...
              <p className="text-neutral-400">Thanjavur, Tamil Nadu, India</p>
            </div>
            <div>
